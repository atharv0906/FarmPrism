...
export const mutationRoutes: Array<{ path: string; command: keyof MutationResults; id?: string }> = [
  ...
  { path: '/api/farmer/orders/:orderId/pickup-otp', command: 'generatePickupOtp', id: 'orderId' },
  { path: '/api/logistics/orders/:orderId/verify-pickup', command: 'verifyPickupOtp', id: 'orderId' },
